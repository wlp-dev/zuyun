...
str;
        ...
        $admin_config->title(L('_USER_CONFIGURATION_'))->data($data)
            ...
            //->keyText('SMS_HTTP', L('_SMS_PLATFORM_HTTP_'), '短信平台HTTP，可用服务商：<a href="http://www.yunsms.cn/" target="_blank">云短信</a>，<a href="http://v2.WPYCMS.cn/index.php?s=/news/index/detail/id/52.html" target="_blank">使用帮助</a>')
